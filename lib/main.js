...
orion.config.publicuploads = false;

orion.filesystem.setuppublicuploads = function(options){
    if(options === true){
        return orion.config.publicuploads = true;
    } else {
        return orion.config.publicuploads = false;
    }
};
